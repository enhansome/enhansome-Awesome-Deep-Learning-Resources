...
* [TensorFlow's GitHub repository](https://github.com/tensorflow/tensorflow) ⭐ 197,047 | 🐛 2,860 | 🌐 C++ | 📅 2026-08-15 - Most known deep learning framework, both high-level and low-level while staying flexible.
* [LSTM for Human Activity Recognition (HAR)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,489 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06 - Tutorial of mine on using LSTMs on time series for classification.
...
* [Awesome Public Datasets](https://github.com/caesar0301/awesome-public-datasets) ⭐ 78,102 | 🐛 158 | 📅 2026-08-04 - An awesome list of public datasets.

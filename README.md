# Awesome Deep Learning Resources with stars
...
* [TensorFlow's GitHub repository](https://github.com/tensorflow/tensorflow) ⭐ 200,295 | 🐛 3,326 | 🌐 C++ | 📅 2026-09-25 - Most known deep learning framework, both high-level and low-level while staying flexible.
* [LSTM for Human Activity Recognition (HAR)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,484 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06 - Tutorial of mine on using LSTMs on time series for classification.
...
* [carpedm20/NTM-tensorflow](https://github.com/carpedm20/NTM-tensorflow) ⭐ 1,046 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2017-05-18 - Neural Turing Machine TensorFlow implementation.
...
* [Deep stacked residual bidirectional LSTMs for HAR](https://github.com/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs) ⭐ 322 | 🐛 3 | 🌐 Python | 📅 2022-11-06 - Improvements on the previous project.
...
* [Clean Machine Learning, a Coding Kata](https://github.com/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code) ⭐ 18 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-11-03 - Learn the good design patterns to use for doing Machine Learning the good way, by practicing.
* [Smoothly Blend Image Patches](https://github.com/guillaume-chevalier/Smoothly-Blend-Image-Patches) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2017-08-25 - Smooth patch merger for [semantic segmentation with a U-Net](https://vooban.com/en/tips-articles-geek-stuff/satellite-image-segmentation-workflow-with-u-net/).
...
* [Awesome Public Datasets](https://github.com/caesar0301/awesome-public-datasets) ⭐ 79,148 | 🐛 161 | 📅 2026-09-23 - An awesome list of public datasets.

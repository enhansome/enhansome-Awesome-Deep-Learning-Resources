...
* [TensorFlow's GitHub repository](https://github.com/tensorflow/tensorflow) ⭐ 197,006 | 🐛 2,856 | 🌐 C++ | 📅 2026-08-14 - Most known deep learning framework, both high-level and low-level while staying flexible.
* [LSTM for Human Activity Recognition (HAR)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,488 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06 - Tutorial of mine on using LSTMs on time series for classification.
...
* [Awesome Public Datasets](https://github.com/caesar0301/awesome-public-datasets) ⭐ 78,084 | 🐛 158 | 📅 2026-08-04 - An awesome list of public datasets.
